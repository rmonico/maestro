...
public class TaskListTests extends MaestroTest {
    ...
    public void should_list_subtasks_by_default() throws EasyMVCException {
        ...
        Assert.assertTask("Parent #10, sub #1", "Parent #10", tasks.get(2));
        Assert.assertTask("Parent #10, sub #1, sub #1", "Parent #10, sub #1", tasks.get(3));
        Assert.assertTask("Parent #10, sub #1, sub #2", "Parent #10, sub #1", tasks.get(4));
        Assert.assertTask("Parent #10, sub #1, sub #3", "Parent #10, sub #1", tasks.get(5));
        Assert.assertTask("Parent #10, sub #1, sub #4", "Parent #10, sub #1", tasks.get(6));
        Assert.assertTask("Parent #10, sub #2", "Parent #10", tasks.get(7));
        ...
        Assert.assertTask("Parent #8, sub #1, sub #1", "Parent #8, sub #1", tasks.get(11));
        Assert.assertTask("Parent #8, sub #1, sub #2", "Parent #8, sub #1", tasks.get(12));
        Assert.assertTask("Parent #8, sub #1, sub #3", "Parent #8, sub #1", tasks.get(13));
        Assert.assertTask("Parent #7", null, tasks.get(14));
        Assert.assertTask("Parent #7, sub #1", "Parent #7", tasks.get(15));
        Assert.assertTask("Parent #7, sub #1, sub #1", "Parent #7, sub #1", tasks.get(16));
        Assert.assertTask("Parent #7, sub #1, sub #2", "Parent #7, sub #1", tasks.get(17));
        Assert.assertTask("Parent #7, sub #1, sub #3", "Parent #7, sub #1", tasks.get(18));
        Assert.assertTask("Parent #7, sub #1, sub #4", "Parent #7, sub #1", tasks.get(19));
        Assert.assertTask("Parent #7, sub #2", "Parent #7", tasks.get(20));
        Assert.assertTask("Parent #7, sub #2, sub #1", "Parent #7, sub #2", tasks.get(21));
        Assert.assertTask("Parent #7, sub #2, sub #2", "Parent #7, sub #2", tasks.get(22));
        Assert.assertTask("Parent #7, sub #2, sub #3", "Parent #7, sub #2", tasks.get(23));
        Assert.assertTask("Parent #7, sub #3", "Parent #7", tasks.get(24));
        Assert.assertTask("Parent #7, sub #4", "Parent #7", tasks.get(25));
        ...
        Assert.assertTask("Parent #4, sub #1", "Parent #4", tasks.get(29));
        Assert.assertTask("Parent #4, sub #2", "Parent #4", tasks.get(30));
        Assert.assertTask("Parent #4, sub #3", "Parent #4", tasks.get(31));
        Assert.assertTask("Parent #4, sub #4", "Parent #4", tasks.get(32));
